---
name: save-memory
description: Decide what to persist to agentmemory. Save architecture decisions, bugs found, patterns, user preferences, workflow rules, lessons. Skip existing code, temp output, anything <10s to find. Trigger: when saving insights to long-term memory.
license: MIT
compatibility: opencode
---

When saving to agentmemory, follow these rules:
